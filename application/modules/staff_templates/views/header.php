...
<!-- Set Flash message -->
<!-- --------------------------------------Departments alarts-------------------------------------- -->
<?php if($this->session->flashdata('salary_agreed')):?>
    <div class="alert alert-info alert-dismissable fade show p-3">
        <div class="row">
            <div class="col-lg-1">
                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
            </div>
            <div class="col-lg-11">
                <center>
                    <p class="mb-0"><?php echo $this->session->flashdata('salary_agreed'); ?></p>
                </center>
            </div>
        </div>
    </div>
