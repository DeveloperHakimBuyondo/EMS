<div id="responsiveTables" class="mb-5"><div class="card">
		<div class="card-body">
			<div class="row">
				...
				<div class="col-lg-10">
					<form method="post" action="<?php echo base_url();?>resignation/search" class="was-validated" enctype="multipart/form-data">
						<div class="input-group">
							<input type="text" name="search" class="form-control form-control-sm" placeholder="Search Resigned Employee Id...">
