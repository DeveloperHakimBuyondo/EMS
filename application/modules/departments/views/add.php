...
<form method="post" action="<?php echo base_url();?>departments/add" class="was-validated" enctype="multipart/form-data">
				...
				<div class="row mb-n3">
					...
					<div class="col-xl-12">
						<div style="padding-bottom: 20px;" class="form-group">
							...
							<input type="text" name="dep_name" class="form-control form-control-sm is-valid" value="" placeholder="Type Departments Name" required/>
						</div>
					</div>

                    <div class="col-xl-12">
						<div style="padding-bottom: 20px;" class="form-group">
							<button style="width: 100%" type="submit" class="btn btn-outline-theme btn-sm">Add Department</button>
						</div>
					</div>
