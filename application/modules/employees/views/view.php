            ...
            <div class="profile-container">
                    ...
                    <div class="desktop-sticky-top">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-fill px-3">
                                ...
                                <?php if($employee['salary'] == 0){ ?>

                                    <?php echo "$: ".number_format($employee['dollar_salary'], 2); ?>

                                <?php }elseif(!$employee['salary'] == 0){ ?>

                                    <?php echo "UGX:".number_format($employee['salary'], 2); ?>
                                <?php }else{ ?>
                    ...
                    if(empty($cv['cv_name'])){ ?>
                        ...
                        <center>
                            <div class="fw-bold"><a href="#" class="text-decoration-none">
                                <a href="<?php echo base_url(); ?>employees/upload_cv" class="text-decoration-none">
                            ...
                            <div class="container">
                                <span>No CV File Attached: </span><a href="<?php echo base_url(); ?>employees/upload_cv"> Upload File Here </a>
                            </div>                           
                        </center>
                ...
                <div class="flex-fill ps-2">
                    <div class="row">
                        ...
                        <?php 
                            if($ln['loan_balance'] < 1 and $ln['dollar_loan_balance'] < 1){ ?>
                           ...
                           <?php }elseif($ln['loan_balance'] > 1 and $ln['dollar_loan_balance'] < 1){ ?>
                          ...
                          <?php  }elseif($ln['loan_balance'] < 1 and $ln['dollar_loan_balance'] > 1){ ?>
                            ...
                            <div class="col-xl-12">
                                <div style="padding-bottom: 30px;" class="form-group">
                                    <input type="hidden" name="balance" value="<?php echo $ln["dollar_loan_balance"];?>">
