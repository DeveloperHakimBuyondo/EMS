...
<?php include('includes/header.php'); ?>
			...
			<div class="register">
                ...
                <form method="post" action="<?php echo base_url();?>users/register" class="was-validated" enctype="multipart/form-data">
					    ...
					    <p class="text-white text-opacity-50 text-center">Register System user | Department Admin</p>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="department_id" class="form-select form-select-lg bg-white bg-opacity-5" required>
                                ...
                                <option value="0">HR / Other...</option>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Select Access Positions | User Roll <span class="text-danger">*</span></label>
                            <select name="user_access" class="form-select form-select-lg bg-white bg-opacity-5" required>
                                <option selected disabled value="">Select user roll...</option>
					...
					Already have an Access ID? <a href="<?php echo base_url(); ?>users/login">Department Login</a>
