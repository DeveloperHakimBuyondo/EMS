...
<div class="register">
    ...
    <div class="register-content">
                ...
                <!-- Set Flash message -->
				<!-- --------------------------------------User Login passed alarts-------------------------------------- -->
                <?php if($this->session->flashdata('no_login')):?>
                    <div class="alert alert-danger alert-dismissable fade show p-3">
                        <div class="row">
                            <div class="col-lg-1">
                                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                            ...
                            <div class="col-lg-11">
                                <center>
                                    <p class="mb-0"><?php echo $this->session->flashdata('no_login'); ?></p>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Set Flash message -->
				<!-- --------------------------------------User Login passed alarts-------------------------------------- -->
                <?php if($this->session->flashdata('user_regist_failed')):?>
                    <div class="alert alert-danger alert-dismissable fade show p-3">
                        <div class="row">
                            <div class="col-lg-1">
                                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                            ...
                            <div class="col-lg-11">
                                <center>
                                    <p class="mb-0"><?php echo $this->session->flashdata('user_regist_failed'); ?></p>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Set Flash message -->
				<!-- --------------------------------------User Login passed alarts-------------------------------------- -->
                <?php if($this->session->flashdata('username_failed')):?>
                    <div class="alert alert-danger alert-dismissable fade show p-3">
                        <div class="row">
                            <div class="col-lg-1">
                                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                            ...
                            <div class="col-lg-11">
                                <center>
                                    <p class="mb-0"><?php echo $this->session->flashdata('username_failed'); ?></p>
                                </center>
                            </div>
                        </div>
                    </div>
    ...
    <form method="post" action="<?php echo base_url();?>users/login" class="was-validated" enctype="multipart/form-data">
        ...
        Don't have an Access ID? <a href="<?php echo base_url(); ?>users/register">Create Access</a>
        / <a href="<?php echo base_url(); ?>users/worker_login">Employee Login</a>
        </div>
        </form>
    </div>
