				...
				<div class="row mb-n3">
					...
					<div class="col-xl-3">
						<div style="padding-bottom: 30px;" class="form-group">
							...
							<input class="form-control form-control-sm is-valid" type="date" min="<?php echo date('Y-m-d'); ?>" name="pay_from" placeholder="Pay Installment from" required />
						</div>
					</div>
					...
					<div class="col-xl-3">
						<div style="padding-bottom: 20px;" class="form-group">
							<label style="padding-bottom: 5px;" class="text-theme"><span class="text-danger">*</span> Select Your Employee Name: </label>
