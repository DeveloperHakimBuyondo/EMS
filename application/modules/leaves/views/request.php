...
<form method="post" action="<?php echo base_url();?>leaves/request" class="was-validated" enctype="multipart/form-data">
				...
				<div class="row mb-n3">
					...
					<div class="col-xl-4">
						<div style="padding-bottom: 30px;" class="form-group">
							...
							<input class="form-control form-control-sm is-valid" min="<?php echo date('Y-m-d'); ?>" type="date" name="start_date" placeholder="Start Date" required />
						</div>
					</div>
					...
					<div class="col-xl-4">
						<div style="padding-bottom: 30px;" class="form-group">
							...
							<input class="form-control form-control-sm is-valid" min="<?php echo date('Y-m-d'); ?>" type="date" name="end_date" placeholder="End Date" required />
						</div>
					</div>
