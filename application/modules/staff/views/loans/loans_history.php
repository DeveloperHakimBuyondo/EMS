                                ...
                                <div class="tab-content p-0">
                                        ...
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item d-flex align-items-center">
                                                ...
                                                <div class="flex-fill px-3">
                                                    ...
                                                    <div class="text-white text-opacity-50 fs-13px"> <a class=" text-decoration-none text text-theme" href="<?php echo base_url(); ?>staff/employees/view/<?php echo $pending->emp_id; ?>"><?php echo $pending->emp_name; ?></a></div>
                                    ...
                                    <div class="tab-pane fade" id="aproved">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item d-flex align-items-center">
                                                ...
                                                <div class="flex-fill px-3">
                                                    <div><a href="#" class="text-white fw-bold text-decoration-none"><?php echo "Loan Requested By:"; ?></a></div>
                                                    <div class="text-white text-opacity-50 fs-13px"> <a class=" text-decoration-none text text-theme" href="<?php echo base_url(); ?>staff/employees/view/<?php echo $aproved->emp_id; ?>"><?php echo $aproved->emp_name; ?></a></div>
                                    ...
                                    <div class="tab-pane fade" id="rejected">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item d-flex align-items-center">
                                                ...
                                                <div class="flex-fill px-3">
                                                    <div><a href="#" class="text-white fw-bold text-decoration-none"><?php echo "Loan Requested By:"; ?></a></div>
                                                    <div class="text-white text-opacity-50 fs-13px"> <a class=" text-decoration-none text text-theme" href="<?php echo base_url(); ?>staff/employees/view/<?php echo $rejected->emp_id; ?>"><?php echo $rejected->emp_name; ?></a></div>
                                    ...
                                    <div class="tab-pane fade" id="settled">
                                        <div class="list-group">
                                            ...
                                            <?php if($this->session->userdata('department_id') == $settled->dep_id): ?>
                                            <div class="list-group-item d-flex align-items-center">
