...
<form method="post" action="<?php echo base_url().'loans/request';?>" class="was-validated" enctype="multipart/form-data">
				...
				<div class="row mb-n3">
					...
					<div class="col-xl-4">
						<div style="padding-bottom: 30px;" class="form-group">
							...
							<input class="form-control form-control-sm is-valid" type="date" name="pay_from" placeholder="Pay Installment from" required />
						</div>
					</div>
