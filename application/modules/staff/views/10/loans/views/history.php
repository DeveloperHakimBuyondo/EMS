                                        ...
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item d-flex align-items-center">
                                                ...
                                                <div class="flex-fill px-3">
                                                    ...
                                                    <div class="text-white text-opacity-50 fs-13px"><?php echo number_format($pending->loan_amount, 2); ?></div>
                                                </div>
                                                <div class="flex-fill px-3">
                                                    <div><a href="#" class="text-white fw-bold text-decoration-none"><?php echo "Loan Balance:"; ?></a></div>
                                                    <div class="text-white text-opacity-50 fs-13px"><?php echo number_format($pending->loan_balance, 2); ?></div>
                                                </div>
                                                <div class="flex-fill px-3">
                                                ...
                                                <ul class="nav">
                                                    <li class="nav-item me-1 dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a href="<?php echo base_url(); ?>loans/aprove_loan/<?php echo $pending->loan_id; ?>" class="dropdown-item"> Put In Aproved </a>
                                    ...
                                    <div class="tab-pane fade" id="aproved">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item d-flex align-items-center">
                                                ...
                                                <div class="flex-fill px-3">
                                                    <div><a href="#" class="text-white fw-bold text-decoration-none"><?php echo "Loan Amount:"; ?></a></div>
                                                    <div class="text-white text-opacity-50 fs-13px"><?php echo number_format($aproved->loan_amount, 2); ?></div>
                                                </div>
                                                <div class="flex-fill px-3">
                                                    <div><a href="#" class="text-white fw-bold text-decoration-none"><?php echo "Loan Balance:"; ?></a></div>
                                                    <div class="text-white text-opacity-50 fs-13px"><?php echo number_format($aproved->loan_balance, 2); ?></div>
                                                </div>
                                                <div class="flex-fill px-3">
                                                    <div><a href="#" class="text-white fw-bold text-decoration-none"><?php echo "Loan Status:"; ?></a></div>
                                                    <div class="text-white text-opacity-50 fs-13px">
                                    ...
                                    <div class="tab-pane fade" id="rejected">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item d-flex align-items-center">
                                                ...
                                                <div class="flex-fill px-3">
                                                    <div><a href="#" class="text-white fw-bold text-decoration-none"><?php echo "Loan Amount:"; ?></a></div>
                                                    <div class="text-white text-opacity-50 fs-13px"><?php echo number_format($rejected->loan_amount, 2); ?></div>
                                                </div>
                                                <div class="flex-fill px-3">
                                                    <div><a href="#" class="text-white fw-bold text-decoration-none"><?php echo "Loan Balance:"; ?></a></div>
                                                    <div class="text-white text-opacity-50 fs-13px"><?php echo number_format($rejected->loan_balance, 2); ?></div>
                                                </div>
                                                <div class="flex-fill px-3">
                                                ...
                                                <ul class="nav">
                                                    <li class="nav-item me-1 dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a href="<?php echo base_url(); ?>loans/aprove_loan/<?php echo $rejected->loan_id; ?>" class="dropdown-item"> Put In Aproved </a>
                                                        </div> 
                                                    </li>
                                                </ul>
                                            </div>
