                                                ...
                                                <ul class="nav">
                                                    <li class="nav-item me-1 dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a href="<?php echo base_url(); ?>leaves/accept_leave/<?php echo $pending->leave_id; ?>" class="dropdown-item"> Aprove Leave </a>
											                <a href="<?php echo base_url(); ?>leaves/reject_leave/<?php echo $pending->leave_id; ?>" class="dropdown-item"> Reject Leave </a>
                                                        </div> 
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="list-group-item d-flex align-items-center">
                                                ...
                                                <ul class="nav">
                                                    <li class="nav-item me-1 dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <!-- <a href="<?php //echo base_url(); ?>leaves/view/<?php //echo $leave->leave_id; ?>" class="dropdown-item">Project Information<i class="fab fa-sm fa-fw me-2 fa-firstdraft text-success float-right"></i></a> -->
                                                            <a href="<?php echo base_url(); ?>leaves/pending_leave/<?php echo $aproved->leave_id; ?>" class="dropdown-item"> Pending Leave </a>
											                <a href="<?php echo base_url(); ?>leaves/reject_leave/<?php echo $aproved->leave_id; ?>" class="dropdown-item"> Reject Leave </a>
                                                        </div> 
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="list-group-item d-flex align-items-center">
                                                ...
                                                <ul class="nav">
                                                    <li class="nav-item me-1 dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <!-- <a href="<?php //echo base_url(); ?>leaves/view/<?php //echo $leave->leave_id; ?>" class="dropdown-item">Project Information<i class="fab fa-sm fa-fw me-2 fa-firstdraft text-success float-right"></i></a> -->
                                                            <a href="<?php echo base_url(); ?>leaves/accept_leave/<?php echo $rejected->leave_id; ?>" class="dropdown-item"> Aprove Leave </a>
											                <a href="<?php echo base_url(); ?>leaves/pending_leave/<?php echo $rejected->leave_id; ?>" class="dropdown-item"> Pending Leave </a>
                                                        </div> 
                                                    </li>
                                                </ul>
                                            </div>
