...
<form method="post" action="<?php echo base_url();?>projects/add" class="was-validated" enctype="multipart/form-data">
				...
				<div class="row mb-n3">
					...
					<div class="col-xl-12">
						<div style="padding-bottom: 20px;" class="form-group">
							...
							<input type="text" name="project_name" class="form-control form-control-sm is-valid" value="" placeholder="Project Name" required />
						</div>
					</div>
					...
					<div class="col-xl-6">
						<div style="padding-bottom: 30px;" class="form-group">
							...
							<input class="form-control form-control-sm is-valid" type="date" name="close_date" placeholder="Close Date" required />
						</div>
					</div>
                    ...
                    <div class="col-xl-12">
						<div style="padding-bottom: 20px;" class="form-group">
							<button style="width: 100%" type="submit" class="btn btn-outline-theme btn-sm">Upload Project Data</button>
						</div>
					</div>
