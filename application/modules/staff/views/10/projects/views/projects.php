								...
								<ul class="nav">
									<li class="nav-item me-1 dropdown">
										...
										<div class="dropdown-menu">
											<a href="<?php echo base_url(); ?>projects/view/<?php echo $project->project_id; ?>" class="dropdown-item">Project Information<i class="fab fa-sm fa-fw me-2 fa-firstdraft text-success float-right"></i></a>
											<a href="<?php echo base_url(); ?>projects/edit/<?php echo $project->project_id; ?>" class="dropdown-item">Update Project Information<i class="fas fa-sm fa-fw me-2 fa-edit text-theme float-right"></i></a>
											<a href="<?php echo base_url(); ?>projects/delete/<?php echo $project->project_id; ?>" class="dropdown-item">Delete Project<i class="fas fa-sm fa-fw me-2 fa-trash-alt text-danger float-right"></i></a>
										</div> 
									</li>
								</ul>
							</th>
