			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tbody>
						...
						<?php if($this->session->userdata('department_id') == $leave->dep_id): ?>
						<tr>
								...
								<ul class="nav">
									<li class="nav-item me-1 dropdown">
										...
										<div class="dropdown-menu">
											...
											<a href="<?php echo base_url(); ?>staff/leaves/accept_leave/<?php echo $leave->leave_id; ?>" class="dropdown-item"> Aprove Leave <i class="fas fa-sm fa-fw me-2 fa-check text-success float-right"></i></a>
											<a href="<?php echo base_url(); ?>staff/leaves/reject_leave/<?php echo $leave->leave_id; ?>" class="dropdown-item"> Reject Leave <i class="far fa-sm fa-fw me-2 fa-thumbs-down text-danger float-right"></i></a>
										</div> 
									</li>
								</ul>
							</th>
