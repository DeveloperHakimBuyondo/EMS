...
<div class="card-body pt-1">
    ...
    <ul class="nav nav-tabs nav-tabs-v2">
        <li class="nav-item me-3"><a href="#project" class="nav-link active" data-bs-toggle="tab">Request a Leave</a></li>
    </ul>


<form method="post" action="<?php echo base_url();?>staff/leaves/request" class="was-validated" enctype="multipart/form-data">
				...
				<div class="row mb-n3">
					...
					<div class="col-xl-12">
						<div style="padding-bottom: 20px;" class="form-group">
							<label style="padding-bottom: 5px;" class="text-theme"><span class="text-danger">*</span> Leave Reason: </label>
							<input type="text" name="reason" class="form-control form-control-sm is-valid" value="" placeholder="Leave Reason" required />
						</div>
					</div>
					...
					<div class="col-xl-4">
						<div style="padding-bottom: 30px;" class="form-group">
							...
							<input class="form-control form-control-sm is-valid" type="date" name="start_date" placeholder="Start Date" required />
						</div>
					</div>

					<div class="col-xl-4">
						<div style="padding-bottom: 30px;" class="form-group">
							<label style="padding-bottom: 5px;" class="text-theme"><span class="text-danger">*</span> End Date: </label>
							<input class="form-control form-control-sm is-valid" type="date" name="end_date" placeholder="End Date" required />
						</div>
					</div>

					<div class="col-xl-4">
						<div style="padding-bottom: 20px;" class="form-group">
							<label style="padding-bottom: 5px;" class="text-theme"><span class="text-danger">*</span> Select Employee Name: </label>
							<select name="emp_id" class="form-select form-select-sm" id="validationTooltip03" required>
								<option selected disabled value="">Choose...</option>
								<?php foreach($employees->result() as $emp): ?>
								<?php if($this->session->userdata('department_id') == $emp->dep_id): ?>
                    ...
                    <div class="col-xl-12">
						<div style="padding-bottom: 20px;" class="form-group">
							<button style="width: 100%" type="submit" class="btn btn-outline-theme btn-sm">Request Leave</button>
						</div>
					</div>
