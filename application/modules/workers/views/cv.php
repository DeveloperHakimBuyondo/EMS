...
<form method="post" action="<?php echo base_url();?>workers/worker_cv/upload_cv" class="was-validated" enctype="multipart/form-data">
                    ...
                    <div class="col-xl-6">
                            <center>
                                ...
                                <div class="col-xl-6 rounded">
                                    <center>
                                    <img  style="border-radius: 16%;" class="img img-thumbnail" src="<?php echo base_url();?>assets/assets/images/employee_images/uploads/cv/cv.png" width="260px" onclick="$('#emp_cv').click()">
                                    </center>
                                ...
                                <div class="col-xl-6">
                                    <center>
                                    <p>Please click the file logo: to Upload Your CV</p>
                                    </center>
                                </div>
                            </center>
                        <br>
