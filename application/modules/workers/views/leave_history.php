                                ...
                                <div class="tab-content p-0">
                                    <div class="tab-pane fade show active" id="pending">
                                        <div class="list-group">
                                            <?php foreach($pending_l->result() as $pending): ?>
                                                ...
                                                <ul class="nav">
                                                    <li class="nav-item me-1 dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="<?php echo base_url(); ?>workers/leaves/cancel_leave/<?php echo $pending->leave_id; ?>" class="dropdown-item"> Cancel Request <i class="fas fa-lg fa-fw me-2 fa-times  text-danger float-right"></i></a>
                                                        </div> 
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="aproved">
                                        <div class="list-group">
                                            <?php foreach($aproved_l->result() as $aproved): ?>
                                    ...
                                    <div class="tab-pane fade" id="rejected">
                                        <div class="list-group">
                                            <?php foreach($rejected_l->result() as $rejected): ?>
