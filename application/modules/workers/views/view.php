    ...
    <div class="card-body p-0">
        <div class="profile">
            <div class="profile-container">
                ...
                <div class="profile-sidebar">
                    <div class="desktop-sticky-top">
                        <div class="profile-img">
                            <img src="<?php echo base_url(); ?>assets/assets/images/employee_images/uploads/<?php echo $worker['emp_image'];?>" alt="" />
                        </div>

                        <h4><?php echo $worker['emp_name'];?></h4>
                        <center><div class="mb-3 text-white text-opacity-50 fw-bold mt-n2">- ID <?php echo $worker['employee_id'];?> - </div></center>
                        <div class="mb-3 text-white text-opacity-50 fw-bold mt-n2"><?php //echo $worker['emp_email'];?></div>
                        <!-- <p>
                        ...
                        <div class="mb-1">
                            <i class="fa fa-map-marker-alt fa-fw text-white text-opacity-50"></i> <?php echo $worker['emp_address'];?>
                        </div>
                        <hr class="mt-4 mb-4" />
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-fill px-3">
                                ...
                                <div class="fs-12px text-white text-opacity-50"><?php echo $worker['emp_phone'];?></div>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-fill px-3">
                                ...
                                <div class="fs-12px text-white text-opacity-50"><?php echo $worker['emp_email'];?></div>
                            </div>
                            <!-- <a href="#" class="btn btn-sm btn-outline-theme fs-11px">Follow</a> -->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-fill px-3">
                                ...
                                <div class="fs-12px text-white text-opacity-50"><?php echo $worker['country_name'];?></div>
                            </div>
                            <!-- <a href="#" class="btn btn-sm btn-outline-theme fs-11px">Follow</a> -->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-fill px-3">
                                ...
                                <div class="fs-12px text-white text-opacity-50"><?php echo $worker['emp_nin'];?></div>
                            </div>
                            <!-- <a href="#" class="btn btn-sm btn-outline-theme fs-11px">Follow</a> -->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-fill px-3">
                                ...
                                <div class="fs-12px text-white text-opacity-50"><?php echo $worker['emp_sex'];?></div>
                            </div>
                            <!-- <a href="#" class="btn btn-sm btn-outline-theme fs-11px">Follow</a> -->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-fill px-3">
                                ...
                                <div class="fs-12px text-white text-opacity-50"><?php echo $worker['emp_date_of_birth'];?></div>
                            </div>
                            <!-- <a href="#" class="btn btn-sm btn-outline-theme fs-11px">Follow</a> -->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-fill px-3">
                                ...
                                <?php if($worker['salary'] == 0){ ?>
                                    <?php echo "$: ".number_format($worker['dollar_salary'], 2); ?>
                                <?php }elseif(!$worker['salary'] == 0){ ?>
                                    <?php echo "UGX:".number_format($worker['salary'], 2); ?>
                                <?php }else{ ?>
                ...
                <div class="d-flex align-items-center mb-3">
                <a href="#" class="text-decoration-none"><img style="border-radius: 8px;" src="<?php echo base_url(); ?>assets/assets/images/employee_images/uploads/<?php echo $worker['emp_image'];?>" alt="" width="50" /></a>
                <div class="flex-fill ps-2">
                <div class="fw-bold"><a href="#" class="text-decoration-none"><?php echo "Department"; ?></a></div>
                <div class="small text-white text-opacity-50"><?php echo $worker['dep_name']; ?></div>

                <hr class="mb-3 mt-1" />

                <div class="fw-bold"><a href="#" class="text-decoration-none"><?php echo "Registered Date"; ?></a></div>
                <div class="small text-white text-opacity-50"><?php echo $worker['emp_date_of_joining']; ?></div>

                <hr class="mb-3 mt-1" />
                
                <div class="fw-bold"><a href="#" class="text-decoration-none"><?php echo "worker Status"; ?></a></div>
                <div class="small text-white text-opacity-50">
                    <?php 

                        if($worker['emp_status'] == 1){
                            ...
                            echo "worker has no status for now";
                        }
                    ?>
                </div>
                </div>
                ...
                <p><?php echo $worker['emp_description']; ?></p>
                <!-- <hr class="mb-3 mt-1" /> -->
                        ...
                        <center>
                            <div class="fw-bold"><a href="#" class="text-decoration-none">
                                <a href="#" class="text-decoration-none">
                                    <img style="border-radius: 18px;" src="<?php echo base_url(); ?>assets/assets/images/employee_images/uploads/cv/cv.png<?php //echo $worker['emp_image'];?>" alt="" width="200" />
                                </a>
                            </div>
                            <div class="container">
                ...
                <div class="small text-white text-opacity-50"><?php echo $worker['emp_facebook']; ?></div>

                <hr class="mb-3 mt-1" />

                <div class="fw-bold"><a href="#" class="text-decoration-none"><?php echo "Twitter"; ?></a></div>
                <div class="small text-white text-opacity-50"><?php echo $worker['emp_twitter']; ?></div>

                <hr class="mb-3 mt-1" />
                
                <div class="fw-bold"><a href="#" class="text-decoration-none"><?php echo "Instagram"; ?></a></div>
                <div class="small text-white text-opacity-50"><?php echo $worker['emp_instagram']; ?></div>

                <hr class="mb-3 mt-1" />

                <div class="fw-bold"><a href="#" class="text-decoration-none"><?php echo "Linked In"; ?></a></div>
                <div class="small text-white text-opacity-50"><?php echo $worker['emp_linkedin']; ?></div>
                </div>
                </div>
                <div class="d-flex align-items-center">
                <img src="assets/img/user/user.jpg" alt="" width="35" class="rounded-circle" />
                ...
                <div class="d-flex align-items-center mb-3">
                <a style="padding: 50px;" href="#" class="text-decoration-none"><img style="border-radius: 8px;" src="<?php echo base_url(); ?>assets/assets/images/employee_images/uploads/<?php echo $worker['emp_image'];?>" alt="" width="50" /></a>
                <div class="flex-fill ps-2">
                    <div class="row">

                        <?php 
                            if($ln['loan_balance'] == 0 and $ln['dollar_loan_balance'] == 0){ ?>
                           ...
                           <?php }elseif($ln['loan_balance'] > 0 and $ln['dollar_loan_balance'] < 1){ ?>
                            
                            <div class="col-xl-12">
                                <div style="padding-bottom: 30px;" class="form-group">
                                    <center>
                                    <span>Loan Balance: </span><h1 class="page-header"><?php echo "UGX: ".number_format($ln["loan_balance"], 2);?></h1>
                                    </center>
                                </div>
                            </div>

                            <?php }elseif($ln['loan_balance'] < 1 and $ln['dollar_loan_balance'] > 0){ ?>

                            <div class="col-xl-12">
                                <div style="padding-bottom: 30px;" class="form-group">
                                    <center>
                                    <span>Loan Balance: </span><h1 class="page-header"><?php echo "USD: ".number_format($ln["dollar_loan_balance"], 2);?></h1>
                                    </center>
                                </div>
                            </div>
                            <!-- <form method="post" action="<?php //echo base_url()."staff/loans/pay_loan/".$ln["loan_id"];?>" class="was-validated" enctype="multipart/form-data">
